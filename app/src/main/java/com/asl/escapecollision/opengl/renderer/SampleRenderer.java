...
//        final float lookZ = -5.0f;
    ...
    public void onDrawFrame(GL10 glUnused)
    {
        ...
        Matrix.translateM(mLightModelMatrix, 0, 0.0f, 1.0f, 3.0f);
        Matrix.rotateM(mLightModelMatrix, 0, 0f/*angleInDegrees*/, 0.0f, 1.0f, 0.0f);
...
//        Matrix.translateM(mModelMatrix, 0, -4.0f, 0.0f, -4.0f);
